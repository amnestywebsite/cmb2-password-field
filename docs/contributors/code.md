...
We also welcome non-code contributions, such as [documentation](https://github.com/amnestywebsite/cmb2-password-field/blob/main/docs/contributors/docs.md), [triage](https://github.com/amnestywebsite/cmb2-password-field/blob/main/docs/contributors/triage.md), and [testing](https://github.com/amnestywebsite/cmb2-password-field/blob/main/docs/contributors/a11y.md).  
...
When creating a new release, the final commit to `main` should contain the appropriate version bump in [`/wp-content/themes/cmb2-password-field/style.css`](https://github.com/amnestywebsite/cmb2-password-field/blob/main/wp-content/themes/cmb2-password-field/style.css), and an update to the changelog at [`/CHANGELOG.md`](https://github.com/amnestywebsite/cmb2-password-field/blob/main/CHANGELOG.md).  
